...
function Result() {
    document.title = "Resultados · Juego de Glécio";
                ...
                <main className="flex max-w-6xl gap-6 p-6 pt-20 md:p-10 lg:gap-24 md:mx-auto md:h-screen items-center">
                    ...
                    <div className="flex flex-col items-center justify-center w-full gap-8 md:w-1/2 lg:w-2/3">
                        <div className="flex flex-col items-center gap-2">
                            <LettersPullUpAnimation text="Se acabo el tiempo" initialDelay={1} className="mb-2 text-4xl font-black leading-8 text-center text-darkPurple" />
                              
                            
                            {/* Bloque de la puntuacion final destacada */}
                        ...
                        <p className="flex items-center justify-center align-middle gap-1 text-lg text-darkGray">
                            ...
                            Mayor puntuacion: {getLocalUserInfo().maxScore || 0}
                        </p>
