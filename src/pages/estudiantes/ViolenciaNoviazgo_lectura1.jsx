...
import imagen1 from "../../assets/images/historietas/modulo1_historieta6.png";
...
const challengeData = {
    question: "¿Qué haces con el último mensaje?",
    options: [
        {
            id: "A",
            text: `"Le respondes rápido: “Tienes razón, me cambio ahora” (para evitar que se enoje).".`,
            isCorrect: false,
        ...
        {
            id: "B",
            text: `"Le escribes: “Me gusta cómo me visto y no voy a cambiarlo. Respeta mi forma de ser. Si sigues controlándome, esto no me hace sentir bien”.".`,
            isCorrect: false,
        ...
        {
            id: "C",
            text: `"No respondes y borras el mensaje, esperando que se calme solo.".`,
            isCorrect: true,
...
function ViolenciaNoviazgoReading() {
...
export default ViolenciaNoviazgoReading;