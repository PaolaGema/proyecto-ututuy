...
import imagen1 from "../../assets/images/historietas/modulo1_historieta4.png";
...
const challengeData = {
    ...
    options: [
        {
            id: "A",
            text: `"No pasa nada, está bien” (aunque te sientas incómoda para no hacer drama)".`,
            isCorrect: false,
        ...
        {
            id: "B",
            text: `"Me gustó que festejaras conmigo, pero prefiero abrazos más suaves o que me preguntes primero. Gracias por darte cuenta".`,
            isCorrect: true,
        ...
        {
            id: "C",
            text: `"“No me gusta que me abracen así, no lo hagas más” (de forma cortante).".`,
            isCorrect: false,
...
function ConsentimientoReading() {
    ...
    const handleSelectOption = (option) => {
        ...
        setTimeout(() => {
            ...
            navigate("/play/sexualidad/respuesta1_consentimiento", {
...
export default ConsentimientoReading;