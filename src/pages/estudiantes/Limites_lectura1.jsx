...
import imagen1 from "../../assets/images/historietas/modulo1_historieta5.png";
...
const challengeData = {
    ...
    options: [
        {
            id: "A",
            text: `"Le contestas rápido con una selfie para que deje de insistir y no se enoje.".`,
            isCorrect: false,
        ...
        {
            id: "B",
            text: `"No respondes y lo dejas en visto, esperando que se canse.".`,
            isCorrect: false,
        ...
        {
            id: "C",
            text: `"Le escribes: “Me gusta charlar en el grupo, pero necesito espacio después de clases para estudiar y descansar. No siempre puedo responder rápido. Gracias por entender”.".`,
            isCorrect: true,
