...
const contentMap = {
    A: {
        quote: `"Esos roles son cosas que aprendemos de la sociedad, no porque seamos diferentes. Podemos hacer lo que nos guste si respetamos a todos".`,
        feedbackTitle: "¡Muy bien!",
        subFeedback: "Los roles de género se aprenden de la historia y cultura que nos rodea, pero debemos saber que NOSOTROS ELEGIMOS LO QUE QUEREMOS HACER.",
        bubbleColor: "#16a34a",
        isCorrect: false,
        imagen: imagenA,
    },
    B: {
        quote: `"Así es la costumbre aquí, mejor ayúdame en la cocina".`,
        feedbackTitle: "Honra tu pasado, pero no te limites para tu futuro. ",
        subFeedback: "Las costumbres son importantes, pero cuando limitan lo que quieres intentar, perdemos la oportunidad de descubrir que toda/os podemos contribuir de muchas formas.",
        bubbleColor: "#FF7A00",
        isCorrect: true,
        imagen: imagenB,
    },
    C: {
        quote: `"No sé, mejor no digamos nada para no pelear".`,
        feedbackTitle: "Siempre es bueno hacer preguntas, antes de quedarte con la duda.",
        subFeedback: "A veces el silencio protege la paz momentánea, pero hablar con respeto abre puertas para que todos expresen lo que sienten y prueben cosas nuevas. ",
        bubbleColor: "#FF7A00",
        isCorrect: false,
        imagen: imagenC,
    },
    ...
    return (
        ...
        >
            ...
            <section className="relative max-w-5xl mx-auto px-6 pt-16">
                <ButtonPageBack to="/play/sexualidad/genero_lectura1" absolute={true}>
                    Lectura
                </ButtonPageBack>
