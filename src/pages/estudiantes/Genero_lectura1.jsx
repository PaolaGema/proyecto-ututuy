...
import imagen1 from "../../assets/images/historietas/modulo1_historieta3.png";
...
const challengeData = {
    question: "Qué le responderías a Elena?",
    options: [
        {
            id: "A",
            text: `"Esos roles son cosas que aprendemos de la sociedad, no porque seamos diferentes. Podemos hacer lo que nos guste si respetamos a todos".`,
            isCorrect: true,
        ...
        {
            id: "B",
            text: `"Así es la costumbre aquí, mejor ayúdame en la cocina".`,
            isCorrect: false,
        ...
        {
            id: "C",
            text: `"No sé, mejor no digamos nada para no pelear".`,
            isCorrect: false,
...
function GeneroReading() {
    document.title = "Lección 2 · Sexo";
    ...
    const handleSelectOption = (option) => {
        ...
        setTimeout(() => {
            ...
            navigate("/play/sexualidad/respuesta1_genero", {
