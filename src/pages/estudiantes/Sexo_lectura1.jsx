...
import imagen1 from "../../assets/images/historietas/modulo1_historieta2.png";
...
const challengeData = {
    ...
    options: [
        {
            id: "A",
            text: `"No sé, mejor no hablemos de eso, da vergüenza".`,
            isCorrect: false,
        ...
        {
            id: "B",
            text: `"Es porque las niñas son más delicadas y los niños más fuertes".`,
            isCorrect: false,
        ...
        {
            id: "C",
            text: `"Son diferencias biológicas normales: las niñas tienen útero y ovarios para la menstruación y posible embarazo; los niños tienen testículos y pene para producir espermatozoides".`,
            isCorrect: true,
