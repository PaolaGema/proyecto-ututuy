...
function SexualidadDefinicionSexo() {
                ...
                <div className="flex flex-col gap-6 md:gap-8">
                    ...
                    <div className="space-y-4">
                        <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl text-balance text-purple-50">
                            El sexo se refiere a las <span className="font-bold underline decoration-[#FF7A00] underline-offset-4">CARACTERÍSTICAS BIOLÓGICAS</span> con las que nacemos: hormonas, genitales internos y externos, y órganos reproductivos.   </p>
                        <p className="text-lg md:text-xl font-medium leading-relaxed max-w-xl text-balance text-purple-50">
                            Estas diferencias hacen que los cuerpos cambien de forma distinta durante la adolescencia (menstruación, desarrollo de senos, voz ronca, vello facial, etc.). Es algo natural y científico.
                    ...
                    <div className="flex items-start md:items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                        ...
                        <p className="text-lg md:text-xl font-bold uppercase italic leading-tight text-[#FFD24D]">
                            ¡Conocer y respetar tu cuerpo es el primer paso!!
                        </p>
                    </div>
...
export default SexualidadDefinicionSexo;