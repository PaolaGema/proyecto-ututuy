...
function Modal({
    ...
    return (
        <motion.div
            ...
            animate="animate"
            exit="exit"
            className="fixed inset-0 flex items-center justify-center w-full h-full px-5 backdrop-blur-sm bg-black/40 z-50" // Fondo levemente oscurecido para dar mas foco
            onClick={onCancel}
        >
            <motion.div
                variants={modalScale}
            ...
            >
                ...
                <div className="flex mt-2 w-full">
                    <ButtonDanger
                        ...
                        onClick={onConfirm}
                        isLoading={isLoading}
                        className="w-full py-4 text-lg font-bold rounded-2xl" // Boton mas robusto para mobile
                    >
                        {confirmText}
                    </ButtonDanger>
                </div>
